...
export const sector3: Sector = {
  ...
  missions: [
    ...
    },
    {
      ...
      microPhases: [
        { id: "3.2.1", puzzleType: "GraphConnect", title: "Primeiro Contato", directive: "Ative o portal ligando o nó 1 de A ao nó 'a' de B.", sets: [setA, setB], mode: 'connect', initialEdges: [], expectedEdges: [{from: '1', to: 'a'}], validationRule: 'exact_edges', example: "Exemplo: Clique no nó '1', depois no nó 'a' para estabelecer que f(1) = a.", wisdomText: "Portal ativado! Você estabeleceu uma relação entre os conjuntos." } as GraphConnectPuzzle,
        { id: "3.2.2", puzzleType: "GraphConnect", title: "Ligar as Arestas", directive: "Conecte os cabos para definir f(1)=a, f(2)=b, f(3)=a.", sets: [setA, setB], mode: 'connect', initialEdges: [], expectedEdges: [{from: '1', to: 'a'}, {from: '2', to: 'b'}, {from: '3', to: 'a'}], validationRule: 'exact_edges', example: "Exemplo: Faremos ligações exatas: 1 aponta para 'a', 2 para 'b', 3 para 'a'.", wisdomText: "Função mapeada visualmente!" } as GraphConnectPuzzle,
        { id: "3.2.3", puzzleType: "GraphConnect", title: "Selecionar Subconjuntos", directive: "Isole (selecione) os nós X={1,2} em A e Y={a,c} em B.", sets: [setA, setB], mode: 'select', initialEdges: [], expectedSelection: ['1', '2', 'a', 'c'], validationRule: 'exact_selection', example: "Exemplo: No modo de seleção, apenas ative/ilumine os nós pedidos clicando neles.", wisdomText: "Subconjuntos isolados no radar." } as GraphConnectPuzzle,
        { id: "3.2.4", puzzleType: "GraphConnect", title: "Determinar Imagem e Pré-imagem", directive: "Dada a função f já mapeada, selecione a imagem de X={1,2} e a pré-imagem de Y={b,d}.", sets: [setA, setB], mode: 'select', initialEdges: [{from:'1',to:'a'}, {from:'2',to:'b'}, {from:'3',to:'b'}], expectedSelection: ['a', 'b', '2', '3'], validationRule: 'exact_selection', example: "Exemplo: Siga as setas a partir de {1,2} para achar a imagem. Faça o caminho inverso a partir de {b,d} para achar a pré-imagem.", wisdomText: "Mapeamento bidirecional confirmado!" } as GraphConnectPuzzle,
      ]
    },
    {
      id: "3.3",
      ...
      microPhases: [
        { id: "3.3.1", puzzleType: "GraphConnect", title: "O Colapso (Falha Injetora)", directive: "Crie uma função válida f: A -> B, mas force uma falha injetora (dois elementos distintos do domínio apontam para o mesmo alvo).", sets: [setA, setB], mode: 'connect', initialEdges: [], validationRule: 'not_injective', example: "Exemplo: Ligue dois nós de A para o mesmo nó em B. Ex: f(1)='a' e f(2)='a'.", wisdomText: "Injetividade quebrada! Ocorreu um colapso no sinal." } as GraphConnectPuzzle,
        { id: "3.3.2", puzzleType: "GraphConnect", title: "O Fio Desconectado (Falha Sobrejetora)", directive: "Crie uma função válida f: A -> B, mas deixe pelo menos um elemento do contradomínio sem pré-imagem conectada.", sets: [setA, setB], mode: 'connect', initialEdges: [], validationRule: 'not_surjective', example: "Exemplo: Faça com que algum nó em B não receba nenhuma seta de A.", wisdomText: "Sobrejetividade anulada! Há energia ociosa em B." } as GraphConnectPuzzle,
      ]
    },
    {
      id: "3.4",
      ...
      microPhases: [
        ...
        { 
          ...
          example: "Exemplo: Somente a sobrejetividade garante que todo o destino é atingido, validando a igualdade perfeita na volta.",
        ...
        { 
          ...
          example: "Exemplo: Somente a injetividade garante exclusividade, impedindo que a pré-imagem capture elementos indesejados.",
